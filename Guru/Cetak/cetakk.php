...
;
    ...
    $query_mysql = mysql_query("SELECT * FROM evaluasi where materi = '$materi' AND nama = '$nama' ORDER BY nama asc")or die(mysql_error());
    $nomor = 1;
    ...
    <?php } ?>
                      ...
                      <div class="row no-print">
						...
						{?>
                          ...
                          <a href="Cetak/evaluasii.php?materi=<?php echo $materi ?>&nama=<?php echo $nama ?>"><i class="fa fa-print"></i> PDF</a>
